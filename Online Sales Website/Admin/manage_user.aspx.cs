    ...
    public partial class manage_user : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if(!Page.IsPostBack)
            {
                ...
                string q = "select * from login_data ";
                ...
                if (ds.Tables["login_data"].Rows.Count > 0)
                {
                    ...
                    GridView1.DataSource = ds.Tables["login_data"];
                    GridView1.DataBind();
        ...
        {
            Response.Redirect("~/Admin/add_new_user.aspx");
        }
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("update.aspx?nm=" + name);
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string q = "delete from login_data where id = '" + id + "'";
            if (con.State == ConnectionState.Closed)
                con.Open();
